...
def main():
    ...
    if print_t_test_data:
        ...
        print("DFS vs connected component", print_t_test(optimised_naive_path_checker_bfs_csv, optimised_naive_path_checker_cc_csv))
        print("cycles vs connected component", print_t_test(optimised_naive_path_checker_cycles_csv, optimised_naive_path_checker_cc_csv))
    ...
    print_spearman_test_data = True

    if print_spearman_test_data:
        print("Spearman: Effect of number of cycles on duplicates (n=5)", print_spearman(duplicates_n5_csv, 'number of cycles'))
        print("Spearman: Effect of number of cycles on duplicates (n=10)", print_spearman(duplicates_n10_csv, 'number of cycles'))
        print("Spearman: Effect of number of covered tiles on naive (n=5)", print_spearman(naive_min_heuristic_n5_csv, 'covered squares'))
        print("Spearman: Effect of number of covered tiles on optimised naive (n=5)", print_spearman(optimised_naive_n5_csv, 'covered squares'))
        print("Spearman: Effect of number of covered tiles on duplicates (n=5)", print_spearman(duplicates_n5_csv, 'covered squares'))
        print("Spearman: Effect of number of covered tiles on naive (n=10)", print_spearman(naive_n10_csv, 'covered squares'))
        print("Spearman: Effect of number of covered tiles on optimised naive (n=10)", print_spearman(optimised_naive_n10_csv, 'covered squares'))
        print("Spearman: Effect of number of covered tiles on duplicates (n=10)", print_spearman(duplicates_n10_csv, 'covered squares'))
