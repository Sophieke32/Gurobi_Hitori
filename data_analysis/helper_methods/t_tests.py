...
# Performs a Welch's t-test on the given data
...
def print_t_test(csv1, csv2):
    ...
    return ("\nT-score: {}\np-value: {}\ndf: {}\nCohen's d: {}\nConfidence Interval: Low: {}, High:{}\n"
            .format(stat.statistic, stat.pvalue, stat.df, cohens_d(csv1, csv2), stat.confidence_interval()[0], stat.confidence_interval()[1]))
