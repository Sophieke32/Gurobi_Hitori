...
def generate_graphs(generate_for_poster=False):
    ...
    save_boxplots_spearman_vs_time(path_files["base"], generate_for_poster, "path", "Influence of number of covered tiles on path runtime", 'number_of_covered_tiles', 'Number of covered tiles')
    ...
    save_boxplots_spearman_vs_time(path_files["base"], generate_for_poster, "path", "Influence of number of duplicate tiles on path runtime", 'number_of_duplicates', 'Number of duplicate tiles')
